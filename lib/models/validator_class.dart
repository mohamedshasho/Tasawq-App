...
class ValidationData {
  ...
  static final GlobalKey<FormState> formKeyValidateMobileScreen =
      GlobalKey<FormState>();
  static final scaffoldKeyMobileScreen = GlobalKey<ScaffoldState>();

  static final GlobalKey<ScaffoldState> scaffoldKeyuserProfile =
      new GlobalKey<ScaffoldState>();
  static bool autoValidateuserProfile = false;
  static final GlobalKey<FormState> formKeyValidateuserProfile =
      GlobalKey<FormState>();

  static final GlobalKey<ScaffoldState> scaffoldKeyDeliveryAddress =
      new GlobalKey<ScaffoldState>();
  static bool autoValidateDeliveryAddress = false;
  static final GlobalKey<FormState> formKeyValidateDeliveryAddress =
      GlobalKey<FormState>();
}
